...
const JobList = ({ job }) => {
   const { id, title, type, location, salary, company } = job;
      ...
      <>
         ...
         <div className="bg-white rounded-xl shadow-md relative">
            <div className="p-4">
               ...
               <button
                  className="text-gray-100 mb-5 p-2 rounded-lg bg-indigo-500 hover:bg-indigo-600 w-max hover:text-gray-200"
